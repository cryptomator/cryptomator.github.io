  ...
  getHubService() {
    return {
      ...
      environment: {
        ...
        QUARKUS_HTTP_HEADER__CONTENT_SECURITY_POLICY__VALUE: `default-src 'self'; connect-src 'self' ${this.cfg.keycloak.publicUrl}; object-src 'none'; child-src 'self'; img-src *; frame-ancestors 'none'`
      }
    }
  }
          ...
          spec: {
            ...
            containers: [{
              ...
              env: [
                ...
                ...(this.cfg.keycloak.useExternal ? [{name: 'QUARKUS_HTTP_HEADER__CONTENT_SECURITY_POLICY__VALUE', value: `default-src 'self'; connect-src 'self' ${this.cfg.keycloak.publicUrl}; object-src 'none'; child-src 'self'; img-src *; frame-ancestors 'none'`}] : [])
              ]
            }]
          }
        }
