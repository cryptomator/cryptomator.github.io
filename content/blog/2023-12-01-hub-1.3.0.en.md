...
1. [Back up the database](https://docs.cryptomator.org/hub/self-hosting-guide/operations/#backup). **:warning: The importance of a working backup cannot be overstated.**
