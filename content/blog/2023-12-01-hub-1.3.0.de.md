...
1. [Sichere die Datenbank](https://docs.cryptomator.org/hub/self-hosting-guide/operations/#backup). **:warning: Die Bedeutung eines funktionierenden Backups kann nicht hoch genug eingeschätzt werden.**
