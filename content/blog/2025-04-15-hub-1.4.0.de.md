...
- **Neue Ereignisse:** Es wurden mehrere zusätzliche [Event-Typen](https://docs.cryptomator.org/hub/admin-guide/audit-logs/#event-types) eingeführt, um sicherheitskritische Aktionen noch besser sichtbar zu machen.
