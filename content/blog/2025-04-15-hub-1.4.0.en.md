...
- **New events:** Several new [event types](https://docs.cryptomator.org/hub/admin-guide/audit-logs/#event-types) were added to better capture security-critical actions.
