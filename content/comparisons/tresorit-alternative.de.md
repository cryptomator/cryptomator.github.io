...
ctatitle: "Möchtest du Cryptomator als Alternative zu Tresorit testen?"
...
comparison:
  ...
  footer: |
    <a class="btn btn-outline-primary w-full px-2 md:px-4 py-1 md:py-1" href="/de/comparisons/tresorit-alternative/" data-umami-event="comparisons-tresorit-cta">Detailvergleich</a>
  generalFeatures:
