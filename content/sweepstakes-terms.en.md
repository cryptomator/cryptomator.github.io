...
Entry is made by completing the survey form at [forms.skymatic.de](https://forms.skymatic.de/s/cmluts1as0002mf014x4ncij7) within the participation period. A valid email address is required to enter.
...
Winners will be selected by random draw among all valid entries after the end of the participation period. The drawing will take place privately.

Winners will be notified by email to the address provided at the time of entry. If a winner does not respond within 14 days of notification, or if the notification email cannot be delivered (e.g., due to an invalid email address), the prize will be forfeited without replacement and an alternate winner will be drawn.

Winners will not be published. Publication in anonymized form (e.g., first name and abbreviated last name) will only occur with the winner's express consent.
...
Participants shall have no claims against the Organizer in such cases.
